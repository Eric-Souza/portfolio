...
export const profile: Profile = {
  ...
  about: [
    "I'm a tech lead and founding engineer based in Brazil. I like owning products end to end, from system design and infra to the UI. I also leverage AI tools to enhance all aspects of work. Over 8 years I've worked in banking, healthcare, e-commerce, AI, legal, and internal tools.",
