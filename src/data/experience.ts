...
export const experience: Experience[] = [
  ...
  },
  {
    ...
    domain: 'Remedy Product (client) · Healthcare',
    bullets: [
      'Worked at EXIT83 on the Remedy Product client engagement, building healthcare software for patient and EEG data tracking.',
